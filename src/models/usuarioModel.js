...
function cadastrar(fk_gestor, cargo, nome, email, senha) {
    ...
    var instrucao = `
       insert into usuario_suporte (fk_empresa, fk_gestor, cargo_usuario_suporte, nome_usuario_suporte, email_usuario_suporte, senha_usuario_suporte) values (1, ${fk_gestor}, '${cargo}', '${nome}', '${email}', '${senha}');
    `;
